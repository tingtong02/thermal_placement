...
module PeripheryBus_pbus(	// @[generators/rocket-chip/src/main/scala/prci/ClockDomain.scala:14:9]
  ...
  output [11:0] auto_coupler_to_device_named_uart_0_control_xing_out_a_bits_source,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:106:25]
  ...
  input  [11:0] auto_coupler_to_device_named_uart_0_control_xing_out_d_bits_source,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:106:25]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[generators/rocket-chip/src/main/scala/prci/ClockDomain.scala:14:9]
    ...
    initial begin	// @[generators/rocket-chip/src/main/scala/prci/ClockDomain.scala:14:9]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[generators/rocket-chip/src/main/scala/prci/ClockDomain.scala:14:9]
        ...
        pad = {_RANDOM[4'h8][31:8], _RANDOM[4'h9], _RANDOM[4'hA][7:0]};	// @[generators/rocket-chip/src/main/scala/prci/ClockDomain.scala:14:9, generators/testchipip/src/main/scala/boot/BootAddrReg.scala:29:34]
      `endif // RANDOMIZE_REG_INIT
    end // initial
