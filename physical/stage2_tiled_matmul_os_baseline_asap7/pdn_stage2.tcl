...
add_pdn_stripe -grid {top} -layer {M1} -width {0.072} -pitch {0.54} -offset {0} -followpins
add_pdn_stripe -grid {top} -layer {M2} -width {0.072} -pitch {0.54} -offset {0} -followpins
add_pdn_stripe -grid {top} -layer {M5} -width {0.096} -spacing {0.096} -pitch {5.4} -offset {0.300}
add_pdn_stripe -grid {top} -layer {M6} -width {0.128} -spacing {0.288} -pitch {5.4} -offset {0.512}
