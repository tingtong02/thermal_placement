...
def write_dry_run(config: dict, errors: list[str]) -> Path:
    ...
    manifest = {
        ...
        "notes": [
            ...
            "Full Stage 2 results will be written under physical/<tag>/ after manager adaptation.",
            "manager/ remains the next implementation area.",
        ],
    }
...
def main() -> int:
    ...
    if args.preflight or args.dry_run:
        ...
        return 0
    print("No action requested. Use --preflight, --dry-run, or --print-config.")
    return 0
